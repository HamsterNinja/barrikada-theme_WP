<template>
  <button ref="favoriteButton" class="product-variations-title__favorite add_favorite" tabindex="0" title="добавить в избранные" v-on:click="setFavorite" :class="{ 'favorited': favorited}">
